...
apt-ftparchive \
    -o APT::FTPArchive::Release::Origin="thanosrepo" \
    -o APT::FTPArchive::Release::Label="thanosrepo" \
    -o APT::FTPArchive::Release::Suite="stable" \
    -o APT::FTPArchive::Release::Version="1.0" \
    -o APT::FTPArchive::Release::Codename="thanosrepo" \
    -o APT::FTPArchive::Release::Architectures="iphoneos-arm64" \
    -o APT::FTPArchive::Release::Components="main" \
    -o APT::FTPArchive::Release::Description="thanosrepo" \
